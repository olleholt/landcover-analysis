...
here::i_am("MEDS/Course/eds223-geospatial/labs/week-9/week9-template.Rmd")
setwd(here())
```
...
filelist <- list.files("./landsat-data/", full.names = TRUE)
...
SB_county_south <- st_read("./SB_county_south.shp")
...
training_data <- st_read("./trainingdata.shp") %>% 
